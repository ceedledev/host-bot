...
module.exports = async (client, member, guild) => {
    ...
    if (!userdb) {
        ...
        client.channels.cache.get('989991450693500948').send('🤵 User is not in the database.')
    }
    if(userdb) {
        await axios({
            ...
            client.channels.cache.get('989991450693500948').send({
                embeds: [
            ...
            client.channels.cache.get('989991450693500948').send('deleting.....')
            if (servers1.length > 0) {
                await client.channels.cache.get('989991450693500948').send({
                    embeds: [
                        new Discord.MessageEmbed()
                        .setColor('#0099ff')
                ...
                await Promise.all(servers1.map(async server => {
                    ...
                    client.channels.cache.get('989991450693500948').send({ embeds: [
                        new Discord.MessageEmbed()
                        .setColor('#0099ff')
