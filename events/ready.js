...
module.exports = async (client) => {
    console.log(chalk.hex('#6b7dfb')(`Ceed Hosting`) + chalk.hex('#6b7dfb')(` is now online!`))
    ...
    setInterval(() => {
        ...
        console.log(chalk.hex('#6b7dfb')(`Ceed Hosting`) + ` | ${chalk.green('[')} ${chalk.blue('Online')} ${chalk.green(']')}`)    
    }, 60000);
